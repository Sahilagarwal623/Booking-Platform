                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                    ...
                    <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-800">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Seats Unavailable</h3>
                            <p className="text-slate-600 dark:text-slate-400 mb-6">
                                {errorModal}
                            </p>
                            <button
                                onClick={() => setErrorModal(null)}
                                className="w-full px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-semibold transition-colors shadow-lg shadow-indigo-500/25"
                            >
