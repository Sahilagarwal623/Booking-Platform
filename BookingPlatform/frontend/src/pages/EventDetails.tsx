...
export default function EventDetails() {
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 h-64 bg-slate-800 rounded-xl animate-pulse" />
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                {event.category && (
                    <span className="inline-block px-3 py-1 bg-indigo-500/10 text-indigo-400 text-sm font-medium rounded-full mb-3">
                        {event.category}
                    </span>
                )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium">{event.venue?.name || 'TBD'}</p>
                                    {event.venue?.address && (
                ...
                <div className="lg:col-span-1">
                    <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 sticky top-24">
                        <h2 className="text-lg font-semibold text-white mb-4">Book Tickets</h2>
