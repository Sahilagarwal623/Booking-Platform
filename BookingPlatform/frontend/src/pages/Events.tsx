                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                            {events.map((event) => (
                                <Link
                                    key={event.id}
                                    to={`/events/${event.id}`}
                                    className="group bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden hover:border-slate-700 hover:bg-slate-900/80 transition-all duration-300 hover:-translate-y-1 h-full flex flex-col"
                                >
                                    {/* Image */}
                                    <div className="h-44 bg-linear-to-br from-indigo-600/20 to-violet-600/20 flex items-center justify-center relative shrink-0">
                                        {event.imageUrl ? (
                                            <img
                                                src={event.imageUrl}
                                        ...
                                        {/* Category badge */}
                                        {event.category && (
                                            <span className="absolute top-3 left-3 px-2 py-1 bg-slate-900/80 text-slate-300 text-xs font-medium rounded-md backdrop-blur-sm">
                                                {event.category}
                                            </span>
                                        )}
                                    </div>
