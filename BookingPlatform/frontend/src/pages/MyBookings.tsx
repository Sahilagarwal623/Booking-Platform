    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-slate-400">Manage and view your event bookings</p>
            </div>
            ...
            {bookings.length === 0 ? (
                <div className="text-center py-16 bg-slate-900/50 border border-slate-800 rounded-xl">
                    ...
                    <p className="text-slate-500 mb-6">Start by browsing our upcoming events</p>
                    <Link
                        to="/events"
                ...
                <div className="space-y-4">
                    {bookings.map((booking) => (
                        ...
                        >
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-start gap-4">
                                        {/* Event Icon */}
                                        <div className="hidden sm:flex items-center justify-center w-12 h-12 bg-indigo-500/10 rounded-lg shrink-0">
                            ...
                            {/* Booked Date */}
                            <p className="text-slate-500 text-xs mt-4 pt-4 border-t border-slate-800">
